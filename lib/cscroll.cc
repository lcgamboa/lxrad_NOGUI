...
void
CScroll::key_press (vEvent event)
{
...
void
CScroll::key_release (vEvent event)
{
};

void
CScroll::button_press (vEvent event)
{
...
void
CScroll::button_release (vEvent event)
{
  Move = false;
...
void
CScroll::mouse_move (vEvent event)
{
 // vEvent Nevent = event;
